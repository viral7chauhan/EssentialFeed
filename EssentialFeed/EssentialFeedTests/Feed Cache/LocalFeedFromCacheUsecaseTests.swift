...
class LocalFeedFromCacheUsecaseTests: XCTestCase {
	...
	private func expect(_ sut: LocalFeedLoader, onCompleteWith expectedResult: Result<[FeedImage], Error>, when action: () -> Void, file: StaticString = #filePath, line: UInt = #line) {
		action()
